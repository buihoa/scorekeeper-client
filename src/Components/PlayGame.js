...
class PlayGame extends Component {
	...
	renderSumScore = (scores) => {
		return (<tr>
			<th>Sum of Score (0)</th>
			{scores.map(scorePlayer => <th>{scorePlayer.reduce((total, score) => total+ Number(score), 0)}</th>)}
		</tr>);
	}
